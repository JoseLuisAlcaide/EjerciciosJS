...
const lDni=["T","R","W","A","G","M","Y","F","P","D","X","B","N","J","Z","S","Q","V","H","L","C","K","E"]
let letra=nDni%23;
console.log(lDni[letra]);
document.writeln(`La letra de su D.N.I.:${nDni} es ${lDni[letra]}`)
...
document.writeln(`La letra de su D.N.I.:${nDni} es ${letra}`)
console.log(letra)
*/